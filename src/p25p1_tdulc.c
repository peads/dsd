 ...
 */
static void read_and_correct_dodeca_word(dsd_opts *opts,
                                         dsd_state *state,
                                         char *dodeca,
                                         int *status_count,
...
void read_zeros(dsd_opts *opts,
    ...
    unsigned int i;
    unsigned int halfLength = length >> 1;
    int analog_signal_index;
...
void processTDULC(dsd_opts *opts, dsd_state *state) {
    ...
    for (i = 5; i >= 0; i--) {
        read_and_correct_dodeca_word(opts,
                state,
                &(dodeca_data[i][0]),
                &status_count,
                analog_signal_array,
    ...
    irrecoverable_errors = check_and_fix_reedsolomon_24_12_13((char *) dodeca_data,
            (char *) dodeca_parity);
    ...
    read_zeros(opts,
            state,
            analog_signal_array + 144, //6 * (6 + 6) + 6 * (6 + 6),
            20,
            &status_count,
    ...
    lcformat[0] = (char) (dodeca_data[5][0] + '0');
    lcformat[1] = (char) (dodeca_data[5][1] + '0');
    lcformat[2] = (char) (dodeca_data[5][2] + '0');
    lcformat[3] = (char) (dodeca_data[5][3] + '0');
    lcformat[4] = (char) (dodeca_data[5][4] + '0');
    lcformat[5] = (char) (dodeca_data[5][5] + '0');
    lcformat[6] = (char) (dodeca_data[5][6] + '0');
    lcformat[7] = (char) (dodeca_data[5][7] + '0');
    mfid[0] = (char) (dodeca_data[5][8] + '0');
    mfid[1] = (char) (dodeca_data[5][9] + '0');
    mfid[2] = (char) (dodeca_data[5][10] + '0');
    mfid[3] = (char) (dodeca_data[5][11] + '0');

    mfid[4] = (char) (dodeca_data[4][0] + '0');
    mfid[5] = (char) (dodeca_data[4][1] + '0');
    mfid[6] = (char) (dodeca_data[4][2] + '0');
    mfid[7] = (char) (dodeca_data[4][3] + '0');
    lcinfo[0] = (char) (dodeca_data[4][4] + '0');
    lcinfo[1] = (char) (dodeca_data[4][5] + '0');
    lcinfo[2] = (char) (dodeca_data[4][6] + '0');
    lcinfo[3] = (char) (dodeca_data[4][7] + '0');
    lcinfo[4] = (char) (dodeca_data[4][8] + '0');
    lcinfo[5] = (char) (dodeca_data[4][9] + '0');
    lcinfo[6] = (char) (dodeca_data[4][10] + '0');
    lcinfo[7] = (char) (dodeca_data[4][11] + '0');

    lcinfo[8] = (char) (dodeca_data[3][0] + '0');
    lcinfo[9] = (char) (dodeca_data[3][1] + '0');
    lcinfo[10] = (char) (dodeca_data[3][2] + '0');
    lcinfo[11] = (char) (dodeca_data[3][3] + '0');
    lcinfo[12] = (char) (dodeca_data[3][4] + '0');
    lcinfo[13] = (char) (dodeca_data[3][5] + '0');
    lcinfo[14] = (char) (dodeca_data[3][6] + '0');
    lcinfo[15] = (char) (dodeca_data[3][7] + '0');
    lcinfo[16] = (char) (dodeca_data[3][8] + '0');
    lcinfo[17] = (char) (dodeca_data[3][9] + '0');
    lcinfo[18] = (char) (dodeca_data[3][10] + '0');
    lcinfo[19] = (char) (dodeca_data[3][11] + '0');

    lcinfo[20] = (char) (dodeca_data[2][0] + '0');
    lcinfo[21] = (char) (dodeca_data[2][1] + '0');
    lcinfo[22] = (char) (dodeca_data[2][2] + '0');
    lcinfo[23] = (char) (dodeca_data[2][3] + '0');
    lcinfo[24] = (char) (dodeca_data[2][4] + '0');
    lcinfo[25] = (char) (dodeca_data[2][5] + '0');
    lcinfo[26] = (char) (dodeca_data[2][6] + '0');
    lcinfo[27] = (char) (dodeca_data[2][7] + '0');
    lcinfo[28] = (char) (dodeca_data[2][8] + '0');
    lcinfo[29] = (char) (dodeca_data[2][9] + '0');
    lcinfo[30] = (char) (dodeca_data[2][10] + '0');
    lcinfo[31] = (char) (dodeca_data[2][11] + '0');

    lcinfo[32] = (char) (dodeca_data[1][0] + '0');
    lcinfo[33] = (char) (dodeca_data[1][1] + '0');
    lcinfo[34] = (char) (dodeca_data[1][2] + '0');
    lcinfo[35] = (char) (dodeca_data[1][3] + '0');
    lcinfo[36] = (char) (dodeca_data[1][4] + '0');
    lcinfo[37] = (char) (dodeca_data[1][5] + '0');
    lcinfo[38] = (char) (dodeca_data[1][6] + '0');
    lcinfo[39] = (char) (dodeca_data[1][7] + '0');
    lcinfo[40] = (char) (dodeca_data[1][8] + '0');
    lcinfo[41] = (char) (dodeca_data[1][9] + '0');
    lcinfo[42] = (char) (dodeca_data[1][10] + '0');
    lcinfo[43] = (char) (dodeca_data[1][11] + '0');

    lcinfo[44] = (char) (dodeca_data[0][0] + '0');
    lcinfo[45] = (char) (dodeca_data[0][1] + '0');
    lcinfo[46] = (char) (dodeca_data[0][2] + '0');
    lcinfo[47] = (char) (dodeca_data[0][3] + '0');
    lcinfo[48] = (char) (dodeca_data[0][4] + '0');
    lcinfo[49] = (char) (dodeca_data[0][5] + '0');
    lcinfo[50] = (char) (dodeca_data[0][6] + '0');
    lcinfo[51] = (char) (dodeca_data[0][7] + '0');
    lcinfo[52] = (char) (dodeca_data[0][8] + '0');
    lcinfo[53] = (char) (dodeca_data[0][9] + '0');
    lcinfo[54] = (char) (dodeca_data[0][10] + '0');
    lcinfo[55] = (char) (dodeca_data[0][11] + '0');
