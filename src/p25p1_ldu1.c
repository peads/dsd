...
void processLDU1(dsd_opts *opts, dsd_state *state) {
    ...
    irrecoverable_errors = check_and_fix_reedsolomon_24_12_13((char *) hex_data,
            (char *) hex_parity);
    ...
    lcformat[0] = (char) (hex_data[11][0] + '0');
    lcformat[1] = (char) (hex_data[11][1] + '0');
    lcformat[2] = (char) (hex_data[11][2] + '0');
    lcformat[3] = (char) (hex_data[11][3] + '0');
    lcformat[4] = (char) (hex_data[11][4] + '0');
    lcformat[5] = (char) (hex_data[11][5] + '0');

    lcformat[6] = (char) (hex_data[10][0] + '0');
    lcformat[7] = (char) (hex_data[10][1] + '0');
    mfid[0] = (char) (hex_data[10][2] + '0');
    mfid[1] = (char) (hex_data[10][3] + '0');
    mfid[2] = (char) (hex_data[10][4] + '0');
    mfid[3] = (char) (hex_data[10][5] + '0');

    mfid[4] = (char) (hex_data[9][0] + '0');
    mfid[5] = (char) (hex_data[9][1] + '0');
    mfid[6] = (char) (hex_data[9][2] + '0');
    mfid[7] = (char) (hex_data[9][3] + '0');
    lcinfo[0] = (char) (hex_data[9][4] + '0');
    lcinfo[1] = (char) (hex_data[9][5] + '0');

    lcinfo[2] = (char) (hex_data[8][0] + '0');
    lcinfo[3] = (char) (hex_data[8][1] + '0');
    lcinfo[4] = (char) (hex_data[8][2] + '0');
    lcinfo[5] = (char) (hex_data[8][3] + '0');
    lcinfo[6] = (char) (hex_data[8][4] + '0');
    lcinfo[7] = (char) (hex_data[8][5] + '0');

    lcinfo[8] = (char) (hex_data[7][0] + '0');
    lcinfo[9] = (char) (hex_data[7][1] + '0');
    lcinfo[10] = (char) (hex_data[7][2] + '0');
    lcinfo[11] = (char) (hex_data[7][3] + '0');
    lcinfo[12] = (char) (hex_data[7][4] + '0');
    lcinfo[13] = (char) (hex_data[7][5] + '0');

    lcinfo[14] = (char) (hex_data[6][0] + '0');
    lcinfo[15] = (char) (hex_data[6][1] + '0');
    lcinfo[16] = (char) (hex_data[6][2] + '0');
    lcinfo[17] = (char) (hex_data[6][3] + '0');
    lcinfo[18] = (char) (hex_data[6][4] + '0');
    lcinfo[19] = (char) (hex_data[6][5] + '0');

    lcinfo[20] = (char) (hex_data[5][0] + '0');
    lcinfo[21] = (char) (hex_data[5][1] + '0');
    lcinfo[22] = (char) (hex_data[5][2] + '0');
    lcinfo[23] = (char) (hex_data[5][3] + '0');
    lcinfo[24] = (char) (hex_data[5][4] + '0');
    lcinfo[25] = (char) (hex_data[5][5] + '0');

    lcinfo[26] = (char) (hex_data[4][0] + '0');
    lcinfo[27] = (char) (hex_data[4][1] + '0');
    lcinfo[28] = (char) (hex_data[4][2] + '0');
    lcinfo[29] = (char) (hex_data[4][3] + '0');
    lcinfo[30] = (char) (hex_data[4][4] + '0');
    lcinfo[31] = (char) (hex_data[4][5] + '0');

    lcinfo[32] = (char) (hex_data[3][0] + '0');
    lcinfo[33] = (char) (hex_data[3][1] + '0');
    lcinfo[34] = (char) (hex_data[3][2] + '0');
    lcinfo[35] = (char) (hex_data[3][3] + '0');
    lcinfo[36] = (char) (hex_data[3][4] + '0');
    lcinfo[37] = (char) (hex_data[3][5] + '0');

    lcinfo[38] = (char) (hex_data[2][0] + '0');
    lcinfo[39] = (char) (hex_data[2][1] + '0');
    lcinfo[40] = (char) (hex_data[2][2] + '0');
    lcinfo[41] = (char) (hex_data[2][3] + '0');
    lcinfo[42] = (char) (hex_data[2][4] + '0');
    lcinfo[43] = (char) (hex_data[2][5] + '0');

    lcinfo[44] = (char) (hex_data[1][0] + '0');
    lcinfo[45] = (char) (hex_data[1][1] + '0');
    lcinfo[46] = (char) (hex_data[1][2] + '0');
    lcinfo[47] = (char) (hex_data[1][3] + '0');
    lcinfo[48] = (char) (hex_data[1][4] + '0');
    lcinfo[49] = (char) (hex_data[1][5] + '0');

    lcinfo[50] = (char) (hex_data[0][0] + '0');
    lcinfo[51] = (char) (hex_data[0][1] + '0');
    lcinfo[52] = (char) (hex_data[0][2] + '0');
    lcinfo[53] = (char) (hex_data[0][3] + '0');
    lcinfo[54] = (char) (hex_data[0][4] + '0');
    lcinfo[55] = (char) (hex_data[0][5] + '0');
