...
int read_dibit(dsd_opts *opts,
    ...
    output[0] = (char) (1 & (dibit >> 1));      // bit 1
    output[1] = (char) (1 & dibit);             // bit 0

    return dibit;
}

void read_dibit_update_analog_data(dsd_opts *opts,
                                   dsd_state *state,
                                   char *output,
                                   unsigned int count,
                                   int *status_count,
...
void read_word(dsd_opts *opts,
    ...
    read_dibit_update_analog_data(opts,
            state,
            word,
            length,
            status_count,
...
void read_golay24_parity(dsd_opts *opts,
                         dsd_state *state,
                         char *parity,
                         int *status_count,
                         AnalogSignal *analog_signal_array,
...
void read_hamm_parity(dsd_opts *opts,
                      dsd_state *state,
                      char *parity,
                      int *status_count,
                      AnalogSignal *analog_signal_array,
 ...
 */
static void read_and_correct_hex_word(dsd_opts *opts,
                                      dsd_state *state,
                                      char *hex,
                                      int *status_count,
                                      AnalogSignal *analog_signal_array,
...
// TODO figure out refactoring common functionality among these process functions
//  to reduce code duplication/complexity
/**
...
void processHDU(dsd_opts *opts, dsd_state *state) {
    ...
    for (i = 19; i >= 0; i--) {
        read_and_correct_hex_word(opts,
                state,
                hex,
                &status_count,
                analog_signal_array,
    ...
    irrecoverable_errors = check_and_fix_redsolomon_36_20_17((char *) hex_data,
            (char *) hex_parity);
    if (irrecoverable_errors != 0) {
        ...
        contribute_to_heuristics(state->rf_mod,
                &(state->p25_heuristics),
                analog_signal_array,
                20 * (3 + 6) + 16 * (3 + 6));
    }
    ...
    mi[0] = (char) (hex_data[19][0] + '0');
    mi[1] = (char) (hex_data[19][1] + '0');
    mi[2] = (char) (hex_data[19][2] + '0');
    mi[3] = (char) (hex_data[19][3] + '0');
    mi[4] = (char) (hex_data[19][4] + '0');
    mi[5] = (char) (hex_data[19][5] + '0');

    mi[6] = (char) (hex_data[18][0] + '0');
    mi[7] = (char) (hex_data[18][1] + '0');
    mi[8] = (char) (hex_data[18][2] + '0');
    mi[9] = (char) (hex_data[18][3] + '0');
    mi[10] = (char) (hex_data[18][4] + '0');
    mi[11] = (char) (hex_data[18][5] + '0');

    mi[12] = (char) (hex_data[17][0] + '0');
    mi[13] = (char) (hex_data[17][1] + '0');
    mi[14] = (char) (hex_data[17][2] + '0');
    mi[15] = (char) (hex_data[17][3] + '0');
    mi[16] = (char) (hex_data[17][4] + '0');
    mi[17] = (char) (hex_data[17][5] + '0');

    mi[18] = (char) (hex_data[16][0] + '0');
    mi[19] = (char) (hex_data[16][1] + '0');
    mi[20] = (char) (hex_data[16][2] + '0');
    mi[21] = (char) (hex_data[16][3] + '0');
    mi[22] = (char) (hex_data[16][4] + '0');
    mi[23] = (char) (hex_data[16][5] + '0');

    mi[24] = (char) (hex_data[15][0] + '0');
    mi[25] = (char) (hex_data[15][1] + '0');
    mi[26] = (char) (hex_data[15][2] + '0');
    mi[27] = (char) (hex_data[15][3] + '0');
    mi[28] = (char) (hex_data[15][4] + '0');
    mi[29] = (char) (hex_data[15][5] + '0');

    mi[30] = (char) (hex_data[14][0] + '0');
    mi[31] = (char) (hex_data[14][1] + '0');
    mi[32] = (char) (hex_data[14][2] + '0');
    mi[33] = (char) (hex_data[14][3] + '0');
    mi[34] = (char) (hex_data[14][4] + '0');
    mi[35] = (char) (hex_data[14][5] + '0');

    mi[36] = (char) (hex_data[13][0] + '0');
    mi[37] = (char) (hex_data[13][1] + '0');
    mi[38] = (char) (hex_data[13][2] + '0');
    mi[39] = (char) (hex_data[13][3] + '0');
    mi[40] = (char) (hex_data[13][4] + '0');
    mi[41] = (char) (hex_data[13][5] + '0');

    mi[42] = (char) (hex_data[12][0] + '0');
    mi[43] = (char) (hex_data[12][1] + '0');
    mi[44] = (char) (hex_data[12][2] + '0');
    mi[45] = (char) (hex_data[12][3] + '0');
    mi[46] = (char) (hex_data[12][4] + '0');
    mi[47] = (char) (hex_data[12][5] + '0');

    mi[48] = (char) (hex_data[11][0] + '0');
    mi[49] = (char) (hex_data[11][1] + '0');
    mi[50] = (char) (hex_data[11][2] + '0');
    mi[51] = (char) (hex_data[11][3] + '0');
    mi[52] = (char) (hex_data[11][4] + '0');
    mi[53] = (char) (hex_data[11][5] + '0');

    mi[54] = (char) (hex_data[10][0] + '0');
    mi[55] = (char) (hex_data[10][1] + '0');
    mi[56] = (char) (hex_data[10][2] + '0');
    mi[57] = (char) (hex_data[10][3] + '0');
    mi[58] = (char) (hex_data[10][4] + '0');
    mi[59] = (char) (hex_data[10][5] + '0');

    mi[60] = (char) (hex_data[9][0] + '0');
    mi[61] = (char) (hex_data[9][1] + '0');
    mi[62] = (char) (hex_data[9][2] + '0');
    mi[63] = (char) (hex_data[9][3] + '0');
    mi[64] = (char) (hex_data[9][4] + '0');
    mi[65] = (char) (hex_data[9][5] + '0');

    mi[66] = (char) (hex_data[8][0] + '0');
    mi[67] = (char) (hex_data[8][1] + '0');
    mi[68] = (char) (hex_data[8][2] + '0');
    mi[69] = (char) (hex_data[8][3] + '0');
    mi[70] = (char) (hex_data[8][4] + '0');
    mi[71] = (char) (hex_data[8][5] + '0');

    mfid[0] = (char) (hex_data[7][0] + '0');
    mfid[1] = (char) (hex_data[7][1] + '0');
    mfid[2] = (char) (hex_data[7][2] + '0');
    mfid[3] = (char) (hex_data[7][3] + '0');
    mfid[4] = (char) (hex_data[7][4] + '0');
    mfid[5] = (char) (hex_data[7][5] + '0');

    mfid[6] = (char) (hex_data[6][0] + '0');
    mfid[7] = (char) (hex_data[6][1] + '0');
    algid[0] = (char) (hex_data[6][2] + '0');  // The important algorithm ID. This indicates whether the data is
    algid[1] = (char) (hex_data[6][3] + '0');  // encrypted and if so what is the encryption algorithm used.
    algid[2] = (char) (hex_data[6][4] + '0');  // A code 0x80 here means that the data is unencrypted.
    algid[3] = (char) (hex_data[6][5] + '0');

    algid[4] = (char) (hex_data[5][0] + '0');
    algid[5] = (char) (hex_data[5][1] + '0');
    algid[6] = (char) (hex_data[5][2] + '0');
    algid[7] = (char) (hex_data[5][3] + '0');
    kid[0] = (char) (hex_data[5][4] + '0');
    kid[1] = (char) (hex_data[5][5] + '0');

    kid[2] = (char) (hex_data[4][0] + '0');  // The encryption key ID
    kid[3] = (char) (hex_data[4][1] + '0');
    kid[4] = (char) (hex_data[4][2] + '0');
    kid[5] = (char) (hex_data[4][3] + '0');
    kid[6] = (char) (hex_data[4][4] + '0');
    kid[7] = (char) (hex_data[4][5] + '0');

    kid[8] = (char) (hex_data[3][0] + '0');
    kid[9] = (char) (hex_data[3][1] + '0');
    kid[10] = (char) (hex_data[3][2] + '0');
    kid[11] = (char) (hex_data[3][3] + '0');
    kid[12] = (char) (hex_data[3][4] + '0');
    kid[13] = (char) (hex_data[3][5] + '0');

    kid[14] = (char) (hex_data[2][0] + '0');
    kid[15] = (char) (hex_data[2][1] + '0');
    tgid[0] = (char) (hex_data[2][2] + '0');  // Talk group ID
    tgid[1] = (char) (hex_data[2][3] + '0');
    tgid[2] = (char) (hex_data[2][4] + '0');
    tgid[3] = (char) (hex_data[2][5] + '0');

    tgid[4] = (char) (hex_data[1][0] + '0');
    tgid[5] = (char) (hex_data[1][1] + '0');
    tgid[6] = (char) (hex_data[1][2] + '0');
    tgid[7] = (char) (hex_data[1][3] + '0');
    tgid[8] = (char) (hex_data[1][4] + '0');
    tgid[9] = (char) (hex_data[1][5] + '0');

    tgid[10] = (char) (hex_data[0][0] + '0');
    tgid[11] = (char) (hex_data[0][1] + '0');
    tgid[12] = (char) (hex_data[0][2] + '0');
    tgid[13] = (char) (hex_data[0][3] + '0');
    tgid[14] = (char) (hex_data[0][4] + '0');
    tgid[15] = (char) (hex_data[0][5] + '0');
    ...
    if (opts->p25enc == 1) {
        ...
        fprintf(stderr, "mi: %s algid: $%lx kid: $%lx\n", mi, algidhex, kidhex);
    }
    if (opts->p25lc == 1) {
